...
public class NewVisit extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private void addSpinnerValue() {
        ...
        for (; to_date >= till_date; till_date++) {
            ...
            Log.d("convert", "converted value is" + (Integer.valueOf(till_date).toString()));
    ...
    public void adClient(View v) {
        ...
        Log.d("count", "count is " + parentLinearLayout.getChildCount());
...
//        parentLinearLayout.addView(addrow,parentLinearLayout.getBottom());
        Log.d("count", "Bottom is " + parentLinearLayout.getBottom());
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        if (checktextbox == 1) {
            ...
            from_date = dayfinal;
            Log.d("From Date ", "From hour is" + dayfinal);
        } else {
            tv_todate.setText(dayfinal + "/" + monthfinal + "/" + yearfinal + " :: " + hourfinal + ":" + minutefinal);
            to_date = dayfinal;
            addSpinnerValue();
            Log.d("To Date ", "To hour is" + dayfinal);
        }
        checktextbox = 0;
        Log.d("diff is ", "hour gap is" + (to_date - from_date));
    }
